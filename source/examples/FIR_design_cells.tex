\documentclass[a4paper,11pt,final]{article}
        ...
        \hypersetup
        {   pdfauthor = {Pweave},
            pdftitle={Published from FIR_design_cells.py},
            colorlinks=TRUE,
            linkcolor=black,
            citecolor=blue,
            urlcolor=blue
...
\PY{o}{\PYZlt{}}\PY{n}{matplotlib}\PY{o}{.}\PY{n}{figure}\PY{o}{.}\PY{n}{Figure} \PY{n+nb}{object} \PY{n}{at} \PY{l+m+mh}{0x7fbeb8d96210}\PY{o}{\PYZgt{}}
\PY{o}{\PYZgt{}\PYZgt{}}\PY{o}{\PYZgt{}} \PY{n}{impz}\PY{p}{(}\PY{n}{a}\PY{p}{)}
\PY{o}{\PYZgt{}\PYZgt{}}\PY{o}{\PYZgt{}} \PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
\includegraphics[width= \linewidth]{figures/FIR_design_cells_figure2_1.pdf}
\includegraphics[width= \linewidth]{figures/FIR_design_cells_figure2_2.pdf}
...
\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
\includegraphics[width= \linewidth]{figures/FIR_design_cells_figure3_1.pdf}
...
\begin{figure}[htpb]
\center
\includegraphics[width= \linewidth]{figures/FIR_design_cells_figure4_1.pdf}
