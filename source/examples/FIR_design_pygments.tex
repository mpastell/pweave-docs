...
\PY{n}{In} \PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{:} \PY{n}{a} \PY{o}{=} \PY{n}{signal}\PY{o}{.}\PY{n}{firwin}\PY{p}{(}\PY{n}{n}\PY{p}{,} \PY{n}{cutoff} \PY{o}{=} \PY{l+m+mf}{0.3}\PY{p}{,} \PY{n}{window} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{hamming}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}

\PY{n}{In} \PY{p}{[}\PY{l+m+mi}{3}\PY{p}{]}\PY{p}{:} \PY{c+c1}{\PYZsh{}Frequency and phase response}

\PY{n}{In} \PY{p}{[}\PY{l+m+mi}{4}\PY{p}{]}\PY{p}{:} \PY{n}{mfreqz}\PY{p}{(}\PY{n}{a}\PY{p}{)}

\PY{n}{In} \PY{p}{[}\PY{l+m+mi}{5}\PY{p}{]}\PY{p}{:} \PY{n}{show}\PY{p}{(}\PY{p}{)}

\PY{n}{In} \PY{p}{[}\PY{l+m+mi}{6}\PY{p}{]}\PY{p}{:} \PY{c+c1}{\PYZsh{}Impulse and step response}

\PY{n}{In} \PY{p}{[}\PY{l+m+mi}{7}\PY{p}{]}\PY{p}{:} \PY{n}{figure}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{)}
\PY{n}{Out}\PY{p}{[}\PY{l+m+mi}{7}\PY{p}{]}\PY{p}{:} \PY{o}{\PYZlt{}}\PY{n}{matplotlib}\PY{o}{.}\PY{n}{figure}\PY{o}{.}\PY{n}{Figure} \PY{n+nb}{object} \PY{n}{at} \PY{l+m+mh}{0x7fc8eeb376d0}\PY{o}{\PYZgt{}}
...
\includegraphics[width= \linewidth]{figures/FIR_design_pygments_figure2_2.pdf}
