# -*- coding: utf-8 -*-
#
# Pweave - literate programming with Python documentation build configuration file, created by
...
#sys.path.append(os.path.abspath('../pweave'))
...
copyright = u'2010-2013  <a href="http://mpastell.com">Matti Pastell</a>.'
